...
// BASE
// ==========================================================
const cadastrosBaseSchema = z.object({
...
function validateExactlyOneOrigin(data: {
  id_empresas?: number;
...
// CREATE
// ==========================================================
export const cadastrosCreateSchema = cadastrosBaseSchema.refine(
  validateExactlyOneOrigin,
  {
    message: originValidationMessage
  }
);
...
// UPDATE
// ==========================================================
export const cadastrosUpdateSchema = cadastrosBaseSchema
  .partial()
  .extend({
    id: z
      .number()
