...
clientesRoute.get(
  '/pessoas/:pessoasId',
  controller.findAllClientesPessoasId.bind(controller)
);

// GET -> Busca todos os clientes por empresa
clientesRoute.get(
  '/empresas/:empresasId',
  controller.findAllClientesEmpresasId.bind(controller)
);

// GET -> Lista clientes com detalhes
clientesRoute.get(
  '/details',
  controller.listAllClientesDetails.bind(controller)
);
...
clientesRoute.post(
  '/',
  clientescreateValidation,
  controller.createNewClientes.bind(controller)
);
...
clientesRoute.get(
  '/:clientesId',
  controller.getOneClientesId.bind(controller)
);
...
clientesRoute.patch(
  '/:clientesId',
  clientesupdateValidation,
  controller.updateIdClientes.bind(controller)
);

// DELETE -> Remove consumidor por ID
clientesRoute.delete(
  '/:clientesId',
  controller.removeIdClientes.bind(controller)
);
