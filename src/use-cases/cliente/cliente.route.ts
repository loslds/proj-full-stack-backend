...
clienteRoute.get('cliente/by-pessoa/:pessoaId', (req, res, next) => controller.findAllByPessoaId(req, res, next));
clienteRoute.get('cliente/by-empresa/:empresaId', (req, res, next) => controller.findAllByEmpresaId(req, res, next));
