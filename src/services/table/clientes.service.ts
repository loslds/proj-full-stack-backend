...
// C:\repository\proj-full-stack-backend\src\services\table\clientes.service.ts
  ...
  async create(): Promise<void> {
    ...
    await AppDataSource.query(`
      CREATE TABLE IF NOT EXISTS ${this.tableName} (
        ...
        UNIQUE KEY uk_clientes_nome_fantasy_pessoa_empresa (nome, fantasy, id_pessoas, id_empresas),
