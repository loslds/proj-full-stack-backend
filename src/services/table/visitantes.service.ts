  ...
  async create(): Promise<void> {
    ...
    await AppDataSource.query(`
      CREATE TABLE IF NOT EXISTS ${this.tableName} (
        ...
        UNIQUE KEY uk_visitantes_nome_fantasy_pessoa_empresa (nome, fantasy, id_pessoas, id_empresas),
        ...
        CONSTRAINT fk_visitantes_empresas
          FOREIGN KEY (id_empresas)
          REFERENCES empresas(id)
          ON DELETE RESTRICT
          ON UPDATE CASCADE,

        CONSTRAINT fk_visitantes_pessoas
